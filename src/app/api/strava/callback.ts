...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error("Erreur détaillée lors du callback Strava:", err.response?.data || err.message);
    return NextResponse.json({ error: "Erreur lors du callback Strava", details: err.response?.data || err.message }, { status: 500 });
  }
}